...
- #19 [developer @ playground-core] Implement Scaffold Playground project and core model (depends on 7)
- #62 [developer] Implement Batch-close 18 stale/completed issues (depends on 44)
- #32 [developer @ playground-components] Fix OptAPlaygroundEditorTests compile failures (depends on 11)
- #40 [developer @ playground-components] Mark #11 superseded — replaced by container and editors split
- #64 [developer] Close stale pipeline-generated issues
- #35 [developer @ playground-core] Implement Mark #19 Done — superseded by scaffold issue #7 (depends on 29)
- #41 [developer] Implement Persist superseded status for issue #16 in authoritative workspace state (depends on 36)
- #17 [developer @ playground-host] Expose playground examples in shared host apps (depends on 7, 9, 10, 11, 12, 13)
- #16 [developer] Implement the technical approach and create execution issues (depends on 2)
- #21 [developer @ playground-core] Implement Scaffold Playground unit test project (depends on 8)
- #42 [developer @ playground-core] Implement Mark #21 Done — superseded by test scaffold issue #8 (depends on 30)
- #26 [tester @ playground-core] Test Close superseded issue #19 — PlaygroundDescriptorBase covered by #9 (depends on 23)
- #10 [developer @ playground-components] Implement OptAPlaygroundPreview component
- #11 [developer @ playground-components] Implement OptAPlaygroundEditor and individual editor components
- #24 [developer @ playground-components] Implement OptAPlayground container component (depends on 9)
- #38 [developer @ playground-components] Implement OptAPlaygroundEditor container component
- #69 [developer @ interactive] Implement OptionA.Blazor.Helpers package extraction (depends on 65)
- #18 [tester @ playground-host] Add browser coverage for playground interactions (depends on 15)
- #28 [developer @ playground-components] Fix OptAPlaygroundEditorTests compile failure on missing IElement type (depends on 11)
- #31 [tester] Test Close superseded issue #16 — technical approach already delivered by scaffold and component issues (depends on 27)
- #39 [developer @ playground-components] Implement individual OptAEditor* editor components in Playground
- #12 [developer @ playground-components] Implement OptAPlaygroundCode component
- #46 [developer @ playground-host] Add Buttons playground page to test hosts
- #63 [developer @ playground-components] Implement PlaygroundCodeGenerator helper (depends on 45)
- #70 [developer @ interactive] Implement OptionA.Blazor.Interactive package scope and design (depends on 66)
- #37 [developer @ tests] Fix button interaction E2E regressions in Server and WebAssembly samples
- #13 [developer @ playground-css] Implement playground CSS and Bootstrap defaults
- #47 [developer @ playground-host] Add Tabs playground page to test hosts
- #67 [developer @ blog] Add bUnit tests to Blog display components
- #43 [tester @ playground-components] Test Fix broken playground editor tests (depends on 34)
- #14 [tester @ playground-core] Write comprehensive unit tests for Playground
- #15 [developer @ playground-ci] Integrate Playground into CI and documentation
- #48 [developer @ tests] Fix4 failing button E2E tests
- #61 [developer @ playground-ci] Implement Integrate Playground into CI and README (depends on 55)
- #68 [developer @ blog] Add deprecation markers to Blog.Builder WYSIWYG builders
- #5 [tester @ tests] Expand Playwright E2E and bUnit test coverage to all components (depends on 2)
- #49 [tester @ tests] Add bUnit tests for Carousel and Gallery components
- #50 [tester @ tests] Add bUnit tests for Menu and Modal components
- #51 [tester @ tests] Add bUnit tests for MessageBox and Responsive components
- #52 [tester @ tests] Add bUnit tests for Splitter and Tabs components
- #53 [tester @ tests] Add E2E tests for remaining component pages
- #56 [developer @ storage] Implement typed IndexedDB contracts and model builder (depends on 54)
- #57 [developer @ storage] Implement model-to-migration adapter on existing IndexedDB migrations (depends on 54)
- #58 [developer @ storage] Implement IndexedDbContext CRUD and constrained query pipeline (depends on 54)
- #59 [tester @ storage] Add test coverage for typed IndexedDB context and migrations (depends on 54)
- #60 [developer @ storage] Implement EF-inspired IndexedDB API surface (depends on 54)
- #6 [developer @ storage] Implement EF-like entity and query layer for IndexedDB
