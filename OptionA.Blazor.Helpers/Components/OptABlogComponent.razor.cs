...
public partial class OptABlogComponent
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            _module = await JsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/OptionA.Blazor.Helpers/Components/OptABlogComponent.razor.js");
        }
    ...
    private Dictionary<string, object?> GetMoveToIndexAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.MoveToIndexInput, result);
    }
    ...
    private Dictionary<string, object?> GetMoveToIndexContainerAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.MoveToIndexInputContainer, result);
    }
    ...
    private Dictionary<string, object?> GetMoveUpAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.MoveUpButton, result);
    }
    ...
    private Dictionary<string, object?> GetMoveDownAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.MoveDownButton, result);
    }
    ...
    private Dictionary<string, object?> GetCollapseAttributes()
    {
        ...
        var type = _collapsed
            ? ComponentElementType.ExpandButton
            : ComponentElementType.CollapseButton;

        return StyleProvider.GetAttributes(type, result);
    }
    ...
    private Dictionary<string, object?> GetRemoveAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.RemoveButton, result);
    }
    ...
    private Dictionary<string, object?> GetPropertiesAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesButton, result);
    }
    ...
    private Dictionary<string, object?> GetPropertiesModalAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesModal, result);
    }
    ...
    private Dictionary<string, object?> GetHeaderAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesModalHeader, result);
    }
    ...
    private Dictionary<string, object?> GetContentAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesModalContent, result);
    }
    ...
    private Dictionary<string, object?> GetComponentContentAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.ComponentContent, result);
    }
    ...
    private Dictionary<string, object?> GetCloseButtonAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesModalCloseButton, result);
    }
    ...
    private Dictionary<string, object?> GetSectionAttributes()
    {
        ...
        return StyleProvider.GetAttributes(ComponentElementType.PropertiesModalSection, result);
    }

    private IContent? GetCollapseContent()
    {
        return _collapsed
            ? StyleProvider.GetContent(ComponentElementType.ExpandButton, "Expand")
            : StyleProvider.GetContent(ComponentElementType.CollapseButton, "Collapse");
    }
}
