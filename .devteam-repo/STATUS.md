...
- #50 [tester @ blog-document] Test Harden directive playground override coercion for typed parameters
- #51 [auditor @ repo-audit] Audit recent execution drift
- #49 [frontend-developer @ tests-optiona-blazor-e2e] Investigate failing buttons E2E flows from regression run
- #30 [tester] Test Define and contain OptADocument helper API surface
- #9 [tester] Test Remove Blog.Builder references from solution and test project
- #32 [frontend-developer] Cache inline component parameter coercion after OptAChild inlining
- #5 [docs] Update OptionA.Blazor.Blog/readme.md to cover OptADocument and Markdown authoring
- #15 [tester] Test RemoveOptionA.Blazor.Blog.Builder from OptionA.Blazor.sln
- #18 [frontend-developer @ blog-document] Normalize DocumentMetadata coding style to repo conventions
- #35 [fullstack-developer @ blog-document] Extract DocumentMetadata parsing into injectable service
